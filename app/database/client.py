...
from pymongo.results import (
    InsertOneResult, DeleteResult, UpdateResult)
from app.database.models import MongoDBModel, notset
from app.common.utils import get_current_app, get_timezone


class MongoDBClient(object): 
    '''
    Singleton client for interaction with MongoDB.
    ...
    Please don't use it direcly, use `app.database.utils.get_db_client`.
    '''
