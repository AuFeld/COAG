...
from app.users.user import InvalidPasswordException, ValidatePasswordProtocol
...
def get_users_router(
    ...
    after_update: Optional[Callable[[users.UD, Dict[str, Any], Request], None]] = None,
    ...
    async def _get_or_404(id: UUID4) -> users.BaseUserDB:
    ...
    async def _check_unique_email(
        ...
        updated_user = cast(
            users.BaseUserUpdate, updated_user
    ...
    async def _update_user(
        user: users.BaseUserDB, update_dict: Dict[str, Any], request: Request
    ):
