...
from app.auth import Authenticator, BaseAuthentication
from app.database.base_user import BaseUserDatabase

from app.routes.auth import get_auth_router
from app.routes.register import get_register_router
from app.routes.reset import get_reset_password_router
from app.routes.users import get_users_router
from app.routes.verify import get_verify_router
...
try:
    ...
    from app.routes.oauth import get_oauth_router
...
class FastAPIUsers:
    ...
    _user_model: Type[users.BaseUser]
    _user_create_model: Type[users.BaseUserCreate]
    _user_update_model: Type[users.BaseUserUpdate]
    _user_db_model: Type[users.BaseUserDB]
    ...
    def __init__(
        ...
        user_update_model: Type[users.BaseUserUpdate],
    ...
    def get_verify_router(
        ...
        after_verification_request: Optional[
            Callable[[users.UD, str, Request], None]
        ] = None,
        after_verification: Optional[Callable[[users.UD, Request], None]] = None,
    ) -> APIRouter:
        """
    ...
    def get_reset_password_router(
        ...
        after_reset_password: Optional[Callable[[users.UD, Request], None]] = None,
    ) -> APIRouter:
        """
    ...
    def get_users_router(
        ...
        after_update: Optional[
            Callable[[users.UD, Dict[str, Any], Request], None]
        ] = None,
